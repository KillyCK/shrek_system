package com.shrek.alipay.controller;
...
import com.shrek.alipay.config.AlipayProperties;
...
public class AlipayController {
    ...
    public String query(String orderNo){
        ...
        switch (result.getTradeStatus()) {
            case SUCCESS:
                log.Role("查询返回该订单支付成功: )");

                AlipayTradeQueryResponse resp = result.getResponse();
                log.Role(resp.getTradeStatus());
//                log.Role(resp.getFundBillList());
                break;
