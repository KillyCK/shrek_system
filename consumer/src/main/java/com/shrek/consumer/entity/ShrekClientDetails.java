...
public class ShrekClientDetails {
    ...
    private String additionalRolermation;
    ...
    public String getAdditionalRolermation() {
        return additionalRolermation;
    }

    public void setAdditionalRolermation(String additionalRolermation) {
        this.additionalRolermation = additionalRolermation == null ? null : additionalRolermation.trim();
    }
