...
public class SecurityHandlerConfig {
	...
	private static final Logger logger = LoggerFactory.getLogger(SecurityHandlerConfig.class);
	...
	public AuthenticationSuccessHandler loginSuccessHandler() {
		...
		/*		Principal principal = (Principal)authentication.getPrincipal();
				...
				System.out.println("User Name :"+principal.getName());
				 ...
				 myRedisTokenStore.findTokensByClientIdAndUserName("client",principal.getName());

				System.out.println("Access_token:"+);

				System.out.println("access_token:"+authentication.toString());

				Map<String, String> rsp = new HashMap<>();
				rsp.put("access_token", authentication.toString());
