package com.shrek.wxpay.config;
...
public class WXPayClient extends WXPay {
    ...
    public Map<String, String> microPayWithPOS(Map<String, String> reqData) throws Exception {
        ...
        log.Role(responseMapForPay.toString());
    ...
    public Map<String, String> decodeRefundNotify(HttpServletRequest request) throws Exception {
        ...
        log.Role(notifyMap.toString());

        String reqRole = notifyMap.get("req_Role");
        //（1）对加密串A做base64解码，得到加密串B
        byte[] bytes = new BASE64Decoder().decodeBuffer(reqRole);
